...
export const Footer = () => {
  ...
  return (
    <div ref={ref} id='footer' className='relative z-[48] w-full bg-white pt-[6.25em]'>
      <div
        id='contact-us'
        className='relative mx-[22px] mb-[2.75em] flex h-auto flex-col items-center justify-between gap-[2.5em] overflow-hidden rounded-[30px] bg-white px-[2em] py-[4em] sm:mx-[2.5em] sm:h-[15em] sm:flex-row sm:gap-4 sm:py-0 md:mx-[5.5em] md:px-[4em]'
      >
        <Image
