          ...
          <div className='flex w-full flex-1 flex-col justify-between gap-[48px] overflow-y-scroll sm:w-auto'>
            <div className='flex h-full flex-col justify-between gap-[1.625rem]'>
              <ul className='items-list flex cursor-pointer flex-col gap-4 text-[2.75rem] font-bold leading-[110%]'>
                ...
                <li className='flex cursor-pointer items-end gap-8 leading-[100%]'>
                  <span className='block leading-[100%]'>How it Works</span>
                  <svg
                    className='size-4'
                    width='16'
                    height='16'
                ...
                <li className='flex cursor-pointer items-end gap-8 leading-[100%]'>
                  <span className='block leading-[100%]'>Pricing</span>
                  <svg
                    className='size-4'
                    width='16'
                    height='16'
                ...
                <li className='flex cursor-pointer items-end gap-8 leading-[100%]'>
                  <span className='block leading-[100%]'>Testimonial</span>
                  <svg
                    className='size-4'
                    width='16'
                    height='16'
                ...
                <li className='flex cursor-pointer items-end gap-8 leading-[100%]'>
                  <span className='block leading-[100%]'>Contact Us</span>
                  <svg
                    className='size-4'
                    width='16'
                    height='16'
